defmodule Quintal.VisitaEvento do
  ...
  Tipos: `recado`, `resposta`, `novo_leitor`, `depoimento`. O par
  `(tipo, ref_uri)` é único: a escrita otimista e o eco do firehose
  chegam como o mesmo evento duas vezes, e o índice dedupa.
  ...
  def changeset(evento, attrs) do
    ...
    |> unique_constraint([:tipo, :ref_uri])
